...
const Home = () => {
    ...
    <main className="flex flex-wrap min-h-screen justify-center items-center m-16 ">
      <div className="flex items-center w-full lg:w-1/2">
        <div className="max-w-2xl mb-8">
          ...
          <p className="py-5 px-12 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl 300">
            Embrace Wellness, Embrace Connection: Your MentalWell AI Journey
            Begins Now!
          </p>
  ...
  //       <div className="pt-2 text-gray-400 -400">
  //         <AmazonLogo />
  //       </div>
  //       <div className="text-gray-400 -400">
  //         <VerizonLogo />
  //       </div>
  //       <div className="text-gray-400 -400">
  //         <MicrosoftLogo />
  //       </div>
  //       <div className="pt-1 text-gray-400 -400">
  //         <NetflixLogo />
  //       </div>
  //       <div className="pt-2 text-gray-400 -400">
  //         <SonyLogo />
